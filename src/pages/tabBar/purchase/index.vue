<template>
  ...
  >
    ...
    <view class="bill">
      ...
      <u-grid class="bill_part2" :border="false" align="center">
        <u-grid-item
          class="bill_grid"
          @click="goTo('/pages/tabBar/purchase/components/add-order')"
        >
        ...
        <u-grid-item
          class="bill_grid"
          @click="goTo('/pages/tabBar/purchase/components/add-warehousing')"
        >
          <image src="@/static/ReceiptDoc.png" alt="" class="img_32" />
          <text style="font-size: 24rpx; font-weight: 400">入库单</text>
        </u-grid-item>
        <u-grid-item
          class="bill_grid"
          @click="goTo('/pages/tabBar/purchase/components/add-return')"
        >
    ...
    <view class="bill">
      ...
      <u-grid class="bill_part2" :border="false" align="center">
        <u-grid-item
          class="bill_grid"
          @click="goTo('/pages/tabBar/purchase/components/list-order')"
        >
